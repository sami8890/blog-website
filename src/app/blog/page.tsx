...
const ALL_POSTS: Post[] = [
  ...
  {
    id: 2,
    title: "The Great Quiad-e-Azam",
    description:
      "In the face of immense challenges, Muhammad Ali Jinnah's unwavering determination and visionary leadership led to the historic creation of Pakistan, transforming the dreams of millions into a sovereign nation. His triumphant struggle not only secured a homeland for Muslims but also inspired generations with the power of principled political resistance and national unity.",

    thumbnail: "/all-blog-posts/jinnah1.jpeg",
    category: "politics",
    readTime: "8 min read",
    date: "Nov 15, 2024",
    author: {
  ...
  // New blog posts
  {
    ...
    description:
      "Dive into the challenges of mental health in a hyperconnected world and how technology can both help and hinder emotional well-being.",
    thumbnail: "/all-blog-posts/mental.jpg", 
  ...
  {
    id: 4,
    title: "The Polarizing Landscape of Modern Politics",
    description:
      "An analysis of how global political divisions are shaping policies, societal norms, and international relations in today's world.",
      thumbnail: "/all-blog-posts/politics.jpg",
    category: "Politics",
  ...
  },
  {
    ...
    description:
      "Plan your next adventure with this curated list of must-visit locations, combining natural beauty, culture, and innovation.",
      thumbnail: "/all-blog-posts/picnic.jpg",
    category: "Travel",
    readTime: "5 min read",
    date: "Nov 16, 2024",
    author: {
  ...
  {
    id: 6,
    title: "How Climate Change is Reshaping Urban Design",
    description:
      "Discover how architects and urban planners are innovating to make cities more sustainable in the face of climate challenges.",
      thumbnail: "/all-blog-posts/air-polution.jpeg",
  ...
  },
  {
    ...
    description:
      "Learn about the key trends shaping remote work, from advanced collaboration tools to changes in company culture.",
      thumbnail: "/all-blog-posts/remote.jpeg",
    category: "Business",
    readTime: "6 min read",
    date: "Nov 14, 2024",
    author: {
  ...
  {
    id: 8,
    title: "Cryptocurrency in 2025: What You Need to Know",
    description:
      "An in-depth look at the evolution of cryptocurrency, the rise of regulations, and its impact on the global economy.",
      thumbnail: "/all-blog-posts/crypto.jpeg",
  ...
  {
    id: 9,
    title: "Mastering Personal Branding in the Digital Era",
    description:
      "Tips and strategies to create a strong personal brand that stands out in a competitive online landscape.",
      thumbnail: "/all-blog-posts/kkk.png",
    category: "Career",
    readTime: "8 min read",
    date: "Nov 12, 2024",
    author: {
